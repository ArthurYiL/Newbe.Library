...
{
    public static class EasyuiSelectExtension
    {
...
#region EasyuiCombo
        ...
        public static MvcHtmlString EasyuiCombo(this HtmlHelper htmlHelper, string name)
        {
            return EasyuiCombo(htmlHelper, name, (IEnumerable<SelectListItem>) null, (string) null,
                (IDictionary<string, object>) null);
        }


        public static MvcHtmlString EasyuiCombo(this HtmlHelper htmlHelper, string name, string optionLabel)
        {
            return EasyuiCombo(htmlHelper, name, (IEnumerable<SelectListItem>) null, optionLabel,
                (IDictionary<string, object>) null);
        }
        ...
        {
            return EasyuiCombo(htmlHelper, name, selectList, (string) null,
                (IDictionary<string, object>) null);
        }
        ...
        {
            return EasyuiCombo(htmlHelper, name, selectList, (string) null, htmlAttributes);
        }
        ...
        {
            return EasyuiCombo(htmlHelper, name, selectList, optionLabel,
                (IDictionary<string, object>) null);
        }
        ...
        public static MvcHtmlString EasyuiComboFor<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper,
            Expression<Func<TModel, TProperty>> expression, IEnumerable<SelectListItem> selectList)
        {
            return EasyuiComboFor<TModel, TProperty>(htmlHelper, expression, selectList, (string) null,
                (IDictionary<string, object>) null);
        }
        ...
        {
            return EasyuiComboFor<TModel, TProperty>(htmlHelper, expression, selectList, optionLabel,
                (IDictionary<string, object>) null);
        }
        ...
        {
            return EasyuiEnumComboFor<TModel, TEnum>(htmlHelper, expression, (string) null);
        }
        ...
        {
            return EasyuiEnumComboFor(htmlHelper, expression, (string) null,
                htmlAttributes);
        }
        ...
        {
            return EasyuiEnumComboFor(htmlHelper, expression, optionLabel,
                (IDictionary<string, object>) null);
        }
        ...
        {
            return EasyuiEnumComboFor<TModel, TEnum>(htmlHelper, expression, optionLabel,
                (IDictionary<string, object>) HtmlHelper.AnonymousObjectToHtmlAttributes(htmlAttributes));
        }
...
#region EasyuiComboBox
        ...
        public static MvcHtmlString EasyuiComboBox(this HtmlHelper htmlHelper, string name)
        {
            return EasyuiComboBox(htmlHelper, name, (IEnumerable<SelectListItem>) null, (string) null,
                (IDictionary<string, object>) null);
        }


        public static MvcHtmlString EasyuiComboBox(this HtmlHelper htmlHelper, string name, string optionLabel)
        {
            return EasyuiComboBox(htmlHelper, name, (IEnumerable<SelectListItem>) null, optionLabel,
                (IDictionary<string, object>) null);
        }
        ...
        public static MvcHtmlString EasyuiComboBox(this HtmlHelper htmlHelper, string name,
            IEnumerable<SelectListItem> selectList)
        {
            return EasyuiComboBox(htmlHelper, name, selectList, (string) null,
                (IDictionary<string, object>) null);
        }
        ...
        public static MvcHtmlString EasyuiComboBox(this HtmlHelper htmlHelper, string name,
            IEnumerable<SelectListItem> selectList, IDictionary<string, object> htmlAttributes)
        {
            return EasyuiComboBox(htmlHelper, name, selectList, (string) null, htmlAttributes);
        }
        ...
        public static MvcHtmlString EasyuiComboBox(this HtmlHelper htmlHelper, string name,
            IEnumerable<SelectListItem> selectList, string optionLabel)
        {
            return EasyuiComboBox(htmlHelper, name, selectList, optionLabel,
                (IDictionary<string, object>) null);
        }
        ...
        public static MvcHtmlString EasyuiComboBoxFor<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper,
            Expression<Func<TModel, TProperty>> expression, IEnumerable<SelectListItem> selectList)
        {
            return EasyuiComboBoxFor<TModel, TProperty>(htmlHelper, expression, selectList, (string) null,
                (IDictionary<string, object>) null);
        }
        ...
        public static MvcHtmlString EasyuiComboBoxFor<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper,
            Expression<Func<TModel, TProperty>> expression, IEnumerable<SelectListItem> selectList, string optionLabel)
        {
            return EasyuiComboBoxFor<TModel, TProperty>(htmlHelper, expression, selectList, optionLabel,
                (IDictionary<string, object>) null);
        }
        ...
        public static MvcHtmlString EasyuiEnumComboBoxFor<TModel, TEnum>(this HtmlHelper<TModel> htmlHelper,
            Expression<Func<TModel, TEnum>> expression)
        {
            return EasyuiEnumComboBoxFor<TModel, TEnum>(htmlHelper, expression, (string) null);
        }
        ...
        public static MvcHtmlString EasyuiEnumComboBoxFor<TModel, TEnum>(this HtmlHelper<TModel> htmlHelper,
            Expression<Func<TModel, TEnum>> expression, object htmlAttributes)
        {
            return EasyuiEnumComboBoxFor(htmlHelper, expression, (string) null,
                htmlAttributes);
        }
        ...
        public static MvcHtmlString EasyuiEnumComboBoxFor<TModel, TEnum>(this HtmlHelper<TModel> htmlHelper,
            Expression<Func<TModel, TEnum>> expression, string optionLabel)
        {
            return EasyuiEnumComboBoxFor(htmlHelper, expression, optionLabel,
                (IDictionary<string, object>) null);
        }
        ...
        public static MvcHtmlString EasyuiEnumComboBoxFor<TModel, TEnum>(this HtmlHelper<TModel> htmlHelper,
            Expression<Func<TModel, TEnum>> expression, string optionLabel, object htmlAttributes)
        {
            return EasyuiEnumComboBoxFor<TModel, TEnum>(htmlHelper, expression, optionLabel,
                (IDictionary<string, object>) HtmlHelper.AnonymousObjectToHtmlAttributes(htmlAttributes));
        }
...
#region EasyuiComboBox
        ...
        public static MvcHtmlString EasyuiComboTree(this HtmlHelper htmlHelper, string name)
        {
            return EasyuiComboTree(htmlHelper, name, (IEnumerable<SelectListItem>) null, (string) null,
                (IDictionary<string, object>) null);
        }


        public static MvcHtmlString EasyuiComboTree(this HtmlHelper htmlHelper, string name, string optionLabel)
        {
            return EasyuiComboTree(htmlHelper, name, (IEnumerable<SelectListItem>) null, optionLabel,
                (IDictionary<string, object>) null);
        }
        ...
        public static MvcHtmlString EasyuiComboTree(this HtmlHelper htmlHelper, string name,
            IEnumerable<SelectListItem> selectList)
        {
            return EasyuiComboTree(htmlHelper, name, selectList, (string) null,
                (IDictionary<string, object>) null);
        }
        ...
        public static MvcHtmlString EasyuiComboTree(this HtmlHelper htmlHelper, string name,
            IEnumerable<SelectListItem> selectList, IDictionary<string, object> htmlAttributes)
        {
            return EasyuiComboTree(htmlHelper, name, selectList, (string) null, htmlAttributes);
        }
        ...
        public static MvcHtmlString EasyuiComboTree(this HtmlHelper htmlHelper, string name,
            IEnumerable<SelectListItem> selectList, string optionLabel)
        {
            return EasyuiComboTree(htmlHelper, name, selectList, optionLabel,
                (IDictionary<string, object>) null);
        }
        ...
        public static MvcHtmlString EasyuiComboTreeFor<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper,
            Expression<Func<TModel, TProperty>> expression, IEnumerable<SelectListItem> selectList)
        {
            return EasyuiComboTreeFor<TModel, TProperty>(htmlHelper, expression, selectList, (string) null,
                (IDictionary<string, object>) null);
        }
        ...
        public static MvcHtmlString EasyuiComboTreeFor<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper,
            Expression<Func<TModel, TProperty>> expression, IEnumerable<SelectListItem> selectList, string optionLabel)
        {
            return EasyuiComboTreeFor<TModel, TProperty>(htmlHelper, expression, selectList, optionLabel,
                (IDictionary<string, object>) null);
        }
        ...
        {
            return EasyuiComboTreeFor(htmlHelper, expression, new List<SelectListItem>(), null, null);
        }
