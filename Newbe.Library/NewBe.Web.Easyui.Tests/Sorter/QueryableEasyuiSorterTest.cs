...
{
    public class QueryableEasyuiSorterTest
    {
        public class Item
        {
        ...
        [Theory(DisplayName = "sort queryable items with easyui sort")]
        ...
        public void Normal(SortOrder order)
        {
            ...
            TestHelper.Test()
                ...
                .GetServiceBuilder<QueryableEasyuiSorter<Item>, IQueryableSorter<Item>>()
                .Build()
        ...
        [Theory(DisplayName = "sort queryable items with easyui sort nullableType")]
        [InlineData(SortOrder.Desc)]
        [InlineData(SortOrder.Asc)]
